-- QUICK START: Penalty Wallet System Migration (FIXED)
...
DROP TABLE IF EXISTS public.b2c_transactions CASCADE;
DROP TABLE IF EXISTS public.withdrawal_receipts CASCADE;
DROP TABLE IF EXISTS public.withdrawal_signatories CASCADE;
DROP TABLE IF EXISTS public.penalty_withdrawals CASCADE;
DROP TABLE IF EXISTS public.penalty_payment_records CASCADE;
DROP TABLE IF EXISTS public.penalty_wallet CASCADE;
...
-- ============================================================================
-- STEP 3: CREATE PENALTY WALLET TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 4: CREATE PENALTY PAYMENT RECORDS TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 5: CREATE PENALTY WITHDRAWALS TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 6: CREATE WITHDRAWAL SIGNATORIES TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 7: CREATE WITHDRAWAL RECEIPTS TABLE
-- ============================================================================
...
-- ============================================================================
-- STEP 8: CREATE B2C TRANSACTIONS TABLE
-- ============================================================================
...
CREATE INDEX idx_b2c_transactions_withdrawal_id ON public.b2c_transactions(withdrawal_id);
CREATE INDEX idx_b2c_transactions_mpesa_transaction_id ON public.b2c_transactions(mpesa_transaction_id);
CREATE INDEX idx_b2c_transactions_status ON public.b2c_transactions(status);
...
CREATE TRIGGER b2c_transaction_status_trigger
...
-- ============================================================================
-- STEP 13: INITIALIZE PENALTY WALLET
-- ============================================================================
...
SELECT 
  ...
  'All tables, triggers, indexes, and RLS policies created successfully!' as message,
  now() as completed_at;
...
-- Verify wallet
SELECT 
  'Wallet Initialized' as check_type,
  COUNT(*) as count,
...
-- SETUP COMPLETE
-- ============================================================================
-- The penalty wallet system is now ready to use!
-- You can now:
-- 1. Create penalties for members
-- 2. Process penalty payments
-- 3. Request withdrawals
-- 4. Approve withdrawals with signatories
-- 5. Process B2C transfers
