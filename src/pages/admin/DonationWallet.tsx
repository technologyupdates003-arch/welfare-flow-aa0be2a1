...
export default function DonationWallet() {
      ...
      try {
        ...
        setWithdrawals(
          withdrawalsData?.map((w: any) => ({
            ...w,
            signatories: w.donation_withdrawal_signatories,
          })) || []
        );
  ...
  const handleWithdrawalRequest = async () => {
    ...
    try {
      ...
      const { error: signatoriesError } = await supabase
        .from('donation_withdrawal_signatories')
        .insert(
  ...
  const downloadReceipt = async (withdrawal: WithdrawalRequest) => {
    try {
      ...
      container.innerHTML = `
        <div style="font-family:'Times New Roman', Times, serif;max-width:900px;margin:0 auto;padding:20px;background:white;color:#111827;">
          ...
          <div style="text-align:center;margin-bottom:15px;">
            <p style="font-size:11px;font-weight:bold;color:#f97316;letter-spacing:2px;margin:0;">FUNDS WALLET WITHDRAWAL RECEIPT</p>
          </div>
      ...
      await html2pdf()
        .set({ margin: 10, filename: `donation-withdrawal-receipt-${withdrawal.id}.pdf`, html2canvas: { scale: 2 } })
        .from(container)
        .save();
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Funds Wallet</h1>
        <p className="text-gray-600 mt-2">Manage funds drives and withdrawals</p>
      </div>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Request Funds Wallet Withdrawal
            </DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Textarea
                  placeholder="Explain the purpose of this withdrawal (e.g., Donation drive support, Event sponsorship, Administrative costs)"
      ...
      <Card>
        <CardHeader>
          <CardTitle>Recent Donation Payments</CardTitle>
          <CardDescription>Latest donation payments received</CardDescription>
        </CardHeader>
        <CardContent>
