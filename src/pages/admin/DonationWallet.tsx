    ...
    try {
      ...
      container.innerHTML = `
        <div style="border-bottom:3px solid #f59e0b;padding-bottom:12px;margin-bottom:18px;">
          <h1 style="font-size:20px;margin:0;">Donation Wallet Withdrawal Receipt</h1>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Manage donation campaigns and withdrawals</p>
      </div>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Request Donation Wallet Withdrawal
            </DialogTitle>
            <DialogDescription>
