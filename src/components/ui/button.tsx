...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:translate-y-px",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[0_6px_16px_-4px_hsl(29_100%_50%/0.45)] hover:bg-[hsl(28_100%_45%)] hover:shadow-[0_8px_22px_-4px_hsl(29_100%_50%/0.55)]",
        destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border border-border bg-card shadow-neu-sm hover:text-primary hover:shadow-neu active:shadow-neu-inset",
        secondary:
          "bg-card text-secondary-foreground shadow-neu-sm hover:shadow-neu active:shadow-neu-inset",
