...
export default function StatsCards() {
  ...
  return (
    <GlassStatsGrid
      ...
      stats={[
        { label: "Total Collected", value: `KES ${(stats?.totalCollected || 0).toLocaleString()}`, icon: TrendingUp, sub: "All paid contributions", accent: "from-success/30 to-success/5" },
        ...
        { label: "Penalties Collected", value: `KES ${(stats?.totalPenalties || 0).toLocaleString()}`, icon: TrendingUp, sub: "Penalty wallet", accent: "from-secondary/30 to-secondary/5" },
      ]}
    />
  );
}
