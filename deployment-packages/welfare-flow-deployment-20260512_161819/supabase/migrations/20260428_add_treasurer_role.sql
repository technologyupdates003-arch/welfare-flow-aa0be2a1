...
-- This migration adds the treasurer role with appropriate permissions

-- Step 1: Add treasurer to app_role enum
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'treasurer';

-- Step 2: Create expenses table for treasurer management
...
-- Step 3: Create payouts table for member benefit payouts
...
-- Step 4: Create financial_reports table
...
-- Step 5: Create organization_settings table for treasurer
...
INSERT INTO organization_settings (organization_name, payout_rules)
VALUES ('KHCWW', '{"wedding": 25000, "death": 50000, "retirement": 30000, "emergency": 15000}'::jsonb)
...
-- Step 8: RLS Policies for expenses
...
-- Step 9: RLS Policies for payouts
...
-- Step 10: RLS Policies for financial_reports
...
-- Step 11: RLS Policies for organization_settings
...
-- Step 12: Grant treasurer access to existing tables
